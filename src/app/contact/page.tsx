...
function Page() {
  return (
    <div className="bg-black text-white min-h-screen flex justify-center px-6 sm:px-6 lg:px-10 xl:px-16 cursor-none">
      <div className="w-full max-w-screen-xl flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center py-10">
          <div className="relative w-full max-w-md p-10 rounded-2xl bg-black">
